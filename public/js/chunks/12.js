...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getPackages: function getPackages() {
      ...
      this.$store.dispatch('package/getData', '').then(function (response) {
    ...
    deletePackage: function deletePackage(params) {
      ...
      this.$store.dispatch('package/delete', params[0].id).then(function (response) {
        ...
        _this2.packages = _this2.packages.filter(function (type) {
                              ...
                              [
                                ...
                                _vm.$store.state.auth.AppActiveUser.roles[0]
                                  ...
                                  ? _c(
                                      "vs-td",
                                      {
                                        attrs: { data: packageData.agency.name }
                                      },
                                      [
                                        _vm._v(
                                          "\n                        " +
                                            _vm._s(packageData.agency.name) +
                                            "\n                    "
                                        )
                                      ]
                                    )
